...
//after install cookies then set for middleware.but first imported the cookie
...
async function run() {
  try {
    ...
    //auth related api
    // sending the cookie to client first.
    ...
    app.get('/services/:id', async(req, res)=>{
      ...
      //specific value from array object if i want..otherwise full object will return.
      const options ={
